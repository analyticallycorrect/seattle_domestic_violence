...
from src.featurizers import (CountCalls, FeaturizeCalls, DateDummies, HolidayDummies, EventDummies, MakeDummies, JoinDataFrames, MakeModelInput)
...
def neighborhood_dist_model(X_train, y_train):
    ...
    min_samples_leaf=1, max_features='auto', max_depth=10, bootstrap=True)
